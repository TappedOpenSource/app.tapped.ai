  ...
  return (
    <>
      <div className="h-screen flex flex-col justify-center items-center">
        <h1 className="text-2xl md:text-6xl text-center font-bold">you&apos;ve been approved!</h1>
        ...
        <p className="text-center w-1/3">
          ...
          we will notify you via SMS and email if you&pos;s selected for the next batch.
          <br />
          <br />
          <br />
          <br />
          if you&apos;d like to guarantee your spot in our next batch of beta testers,
