    ...
    <div className={rubik.className}>
      <div className="flex flex-col items-center justify-start pt-12 px-12 bg-[#010F16]">
        <div className="w-full items-center justify-around text-sm lg:flex">
          <div id="by-tapped" className="fixed bottom-0 left-0 flex h-24 w-full items-end justify-center bg-white rounded-lg lg:hidden lg:static lg:h-auto lg:w-auto">
            <a
