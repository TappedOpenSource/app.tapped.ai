    ...
    <section>
      <div className="flex flex-col md:flex-row gap-6 justify-center">
        <div className='mx-4 md:mx-0 md:w-1/4'>
          ...
          <p className='text-lg text-center md:text-left lowercase'>say goodbye to financial stress. Our monthly subscription plans start at just $10, making it accessible for artists of all backgrounds. get the support you need without breaking the bank.</p>
