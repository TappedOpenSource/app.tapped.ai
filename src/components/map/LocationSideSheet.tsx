...
export default function LocationSideSheet({ lat, lng, zoom, venues, isOpen, onOpenChange }: {
    lat: number;
    lng: number;
    zoom: number;
    venues: UserModel[];
    ...
    <>
      <Sheet open={isOpen} onOpenChange={onOpenChange}>
        <SheetContent className={
          cn(authUser === null ? "" : "overflow-y-scroll")
        } side="left" >
          {authUser === null && (
            <>
              <div className="relative z-40">
                <div className="absolute bg-transparent min-h-screen w-full flex flex-col justify-center items-center">
                  <h1 className="text-2xl font-bold text-center">sign up to get in-depth info about live music in an area as well as stats on &gt;100k venues+performers</h1>
