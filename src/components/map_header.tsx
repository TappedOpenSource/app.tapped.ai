...
function MapHeaderUi({ showSearch = true }: { showSearch?: boolean }) {
  ...
  return (
    <>
      <div className="flex w-screen flex-row items-center px-4 pb-1 pt-8 md:px-8 supports-backdrop-blur:bg-background/60 z-20 w-full bg-background/95 backdrop-blur">
